                  ...
                  .then(function (response) {
                     ...
                     if (errorResponse) {
                       if (data.data) {
                         ...
                         return {
                             'clientId': null,
                             'welcomeMessage': 'unknown error' + JSON.stringify(data),
                             'conversationId': null
                         };                       	
                       }
                    }
         ...
         var getResponse = function (question) {
             return $http.post('/api/conversation', {
               ...
               input: question
                 ...
                 var htmlLinks = null, transformedPayload = null;
                 var segment = null;
                 if (watsonResponse) {
                 ...
                 if (!watsonResponse) {
                     ...
                     //not provide a response with anything
